...
public class PickUpFoodUsers extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pick_up_food_users);
		...
		Cursor c=db.rawQuery("select * from addfooduser", null);
		try{
		c.moveToFirst();
		if(c!=null){
			do {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it=new Intent(PickUpFoodUsers.this,PickUpFoodUsersMain.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_pick_up_food_users, menu);
		return true;
	}
