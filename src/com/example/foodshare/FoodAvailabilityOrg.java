...
public class FoodAvailabilityOrg extends Activity {
	SQLiteDatabase db;
	ArrayList<String> al=new ArrayList<String>();
	String food,quantity,details,pickuplocation,pickupendtime,expirationtime,rno,date,oname;
int resID;
ImageView iv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_food_availability_org);
	...
	bt.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            db.execSQL("create table if not exists addfoodorg(oname varchar,rno varchar,fname varchar,quantity varchar,details varchar,pickuplocation varchar,pickupendtime varchar,expirationtime varchar,cdate varchar)");
            db.execSQL("insert into addfoodorg values('"+oname+"','"+rno+"','"+food+"','"+quantity+"','"+details+"','"+pickuplocation+"','"+pickupendtime+"','"+expirationtime+"','"+date+"')");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_food_availability_org, menu);
		return true;
	}
