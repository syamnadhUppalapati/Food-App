...
public class ViewHistoryUser extends Activity {
	SQLiteDatabase db;
	ArrayList<String> al=new ArrayList<String>();
	String uname,phone,fname;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor c=db.rawQuery("select * from addfooduser where uname='"+uname+"' and phone='"+phone+"'", null);
		try{
		c.moveToFirst();
		if(c!=null){
			do {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it=new Intent(ViewHistoryUser.this,ViewHistoryUserMain.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_view_history_user, menu);
		return true;
	}
