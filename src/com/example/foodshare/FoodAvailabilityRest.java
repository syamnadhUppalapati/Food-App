...
public class FoodAvailabilityRest extends Activity {
	SQLiteDatabase db;
	ArrayList<String> al=new ArrayList<String>();
	String food,quantity,details,pickuplocation,pickupendtime,expirationtime,rno,date,rname;
int resID;
ImageView iv;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_food_availability_rest);
	...
	bt.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            db.execSQL("create table if not exists addfoodres(rno varchar,fname varchar,quantity varchar,details varchar,pickuplocation varchar,pickupendtime varchar,expirationtime varchar,cdate varchar,rname)");
            db.execSQL("insert into addfoodres values('"+rno+"','"+food+"','"+quantity+"','"+details+"','"+pickuplocation+"','"+pickupendtime+"','"+expirationtime+"','"+date+"','"+rname+"')");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_food_availability_rest, menu);
		return true;
	}
