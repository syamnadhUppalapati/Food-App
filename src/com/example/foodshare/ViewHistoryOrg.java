...
public class ViewHistoryOrg extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_view_history_org);
		...
		Cursor c=db.rawQuery("select * from addfoodorg where rno='"+rno+"'", null);
		try{
		c.moveToFirst();
		if(c!=null){
			do {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent it=new Intent(ViewHistoryOrg.this,ViewHistoryOrgMain.class);
				it.putExtra("rno", rno);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_view_history_org, menu);
		return true;
	}
